...
fn main() {
    ...
    let o0 = rrt::RectangleBounds {min_pt: (0.0, 3.0), max_pt: (2.0, 5.0)};
    let o1 = rrt::RectangleBounds {min_pt: (4.0, -1.0), max_pt: (6.0, 9.0)};
    let o2 = rrt::RectangleBounds {min_pt: (7.0, 5.0), max_pt: (12.0, 7.0)};
    let o3 = rrt::RectangleBounds {min_pt: (6.0, 2.0), max_pt: (11.0, 3.0)};
